...
export class init1616015226860 implements MigrationInterface {
    name = 'init1616015226860'
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "question_option_snapshot" ("id" SERIAL NOT NULL, "index" integer NOT NULL, "text" character varying NOT NULL, "questionId" integer NOT NULL, CONSTRAINT "PK_7c86eca58a38dbd55e8134475a3" PRIMARY KEY ("id"))`, undefined);
