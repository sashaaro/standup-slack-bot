...
export class Migration20210325174414 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "team" ("id" serial primary key, "name" varchar(255) not null, "status" int2 not null, "workspace_id" varchar(255) not null, "duration" int4 not null default 30, "start" varchar(255) not null default \'11:00\', "days" integer[] not null default \'{0,1,2,3,4}\', "timezone_id" int4 not null, "created_by_id" varchar(255) not null);');
    ...
    this.addSql('create table "team_snapshot" ("id" serial primary key, "origin_team_id" int4 not null, "created_at" timestamptz(0) not null);');
    ...
    this.addSql('create table "answer_request" ("id" varchar(255) not null, "user_standup_id" varchar(255) not null, "question_id" int4 not null, "answer_message" varchar(255) null, "option_id" int4 not null, "created_at" timestamptz(0) not null, "answer_created_at" timestamptz(0) null);');
